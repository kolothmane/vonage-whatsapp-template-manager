...
export function WabaTemplateSelector({ wabaId, templates }: { wabaId: string; templates: TemplateRecord[] }) {
  ...
  async function submit() {
    ...
    setMessage("");
    try {
      const response = await fetch(`/api/wabas/${encodeURIComponent(wabaId)}/templates`, {
        method: "POST",
